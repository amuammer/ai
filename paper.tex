...
\addbibresource{references.bib} % This is your .bib file
...
% affiliations
\author{
\IEEEauthorblockN{Adnan Abu Muammer}
\IEEEauthorblockA{\textit{Researcher} \\
\textit{Arab Islamic Bank}\\
\textit{\url{https://linkedin.com/in/adnancompengr}}\\
Email: adnan.abumuammer@aibnk.com}
\and
\IEEEauthorblockN{Dr. Aiman Abu Samra}
\IEEEauthorblockA{\textit{Associate Professor, Department of Computer Engineering} \\
\textit{Islamic University of Gaza}\\
\textit{\url{https://ps.linkedin.com/in/aiman-abu-samra-201b75b9}}\\
Email: aasamra@iugaza.edu.ps}
}
